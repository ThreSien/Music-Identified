...
//            DecayRate = 0.996;
    ...
    public void getPeak(double featureFreq[]) { //可取到重點波峰，資料處理速度快
        ...
        //----------------------------------------------------------------------
        String temp = realPeak.poll().toString(); //將上面確認好有梵音的頻率轉乘string型態
        String sanskritArr[][] = { //將音階對照表列出，從-1開始到4
            {"8.18", "16.35", "32.70", "65.41", "130.81", "261.63", "C"},
            {"8.66", "17.32", "34.65", "69.30", "138.59", "277.18", "C♯/D♭"},
            {"9.18", "18.35", "36.71", "73.42", "146.83", "293.66", "D"},
            {"9.72", "19.45", "38.89", "77.78", "155.56", "311.13", "D♯/E♭"},
            {"10.30", "20.60", "41.20", "82.41", "164.81", "329.63", "E"},
            {"10.91", "21.83", "43.65", "87.31", "174.61", "349.23", "F"},
            {"11.56", "23.12", "46.25", "92.50", "185.00", "369.99", "F♯/G♭"},
            {"12.25", "24.50", "49.00", "98.00", "196.00", "392.00", "G"},
            {"12.98", "25.96", "51.91", "103.83", "207.65", "415.30", "G♯/A♭"},
            {"13.75", "27.50", "55.00", "110.00", "220.00", "440.00", "A"},
            {"14.57", "29.14", "58.27", "116.54", "233.08", "466.16", "A♯/B♭"},
            {"15.43", "30.87", "61.74", "123.47", "246.94", "493.88", "B"}
        };
        for (String arr[] : sanskritArr) { //逐列判斷是否有在這些區間
            for (int i = 0; i < arr.length; i++) {
                ...
                if (Double.parseDouble(temp) - (i + 1) < Double.parseDouble(arr[i])
                        && Double.parseDouble(arr[i]) < Double.parseDouble(temp) + (i + 1)) {//當i越大，容許誤差也越大
                    System.out.println(arr[6] + "[" + (i - 1) + "]");
                }
            }
