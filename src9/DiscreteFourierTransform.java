...
//        String dbTake = "";
        ...
        if (pMain.finishRec == true) { //若使用者結束錄製
            String dbInputStr = allScale.poll();
//            System.out.println("dbInputStr:" + dbInputStr); //測試用
...
//        System.out.println("sub:"+sub); //測試用
    ...
    public void voice_Compare() {
        ...
        if (voice_Take_User() == null) {
            ...
            most_Similar mostSimilar = new most_Similar();//用來儲存最長lcs的歌曲和地方
...
//                }
//                System.out.println();
                DBwaitForCompare = voice_Take_DB(); //此函示只會取第一筆資料庫資料來比對，所以需要在比對完成後poll資料
...
//                System.out.println();
                ...
                do { //滑軌判斷，為了確保最後一次也要執行才能進入迴圈判斷
                    ...
                    System.out.println("slideSize：" + slideSize + "；slideNum：" + slideNum);
                    System.out.print("DBwaitForCompareSub：");
                    for (int i : DBwaitForCompareSub) {
                        System.out.print(i + " ");
                    }
                    System.out.println();
...
//                    System.out.println("相似度:" + similar + "%");
                    slideNum += (int) (slideSize * 0.2); //排除先前比對的一半
    ...
    class most_Similar {
        ...
        public void getAll() {
            System.out.println("songName：" + songName + " simliarStar：" + simliarStar + " lcsLength：" + lcsLength);
        }
    }
