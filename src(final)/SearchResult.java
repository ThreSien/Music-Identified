...
public class SearchResult extends javax.swing.JFrame implements MouseMotionListener {
    ...
    private void initComponents() {
        ...
        imageShow.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/music.png"))); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(imageShow, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(90, 90, 90)
    ...
    private void SearchParagraphButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchParagraphButtonActionPerformed
        ...
        if (!pMain.startRec) {
            pausePlayer();
            pMain.micClear();
            pMain.searchPart = false;
            pMain.startRec = true;
            pMain.finishRec = false;
            String songname = jList1.getSelectedValue();
            loadDatabaseScale(songname);
        } else {
            pMain.searchPart = false;
            pMain.finishRec = true;
            pMain.searchPart = true;
            try {
                while (!pMain.dff.searchTimeReturn) {
                    TimeUnit.MILLISECONDS.sleep(300);
                }
                resumePlayer();
                int startTime = searchTime;
//                System.out.println("startTime" + startTime);
                player.getClip_ToPlayingTimer().setFramePosition(startTime * 48_000);
                pMain.dff.searchTimeReturn = false;
            } catch (Exception ex) {
            }
        }
    ...
    private void jList1MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jList1MouseClicked
        // TODO add your handling code here:
//        System.out.println("isPlayingOut" + isPlaying);
        if (selectedSongName.isEmpty()) {
            selectedSongName = jList1.getSelectedValue();//歌曲名
            loadDatabaseImage(selectedSongName);
            imageShow.setIcon(new javax.swing.ImageIcon(getClass().getResource(imagepath)));
            playBack();
        } else if (!selectedSongName.equals(jList1.getSelectedValue())) {
            System.out.println(selectedSongName + "=>" + jList1.getSelectedValue());
            stopPlaying();
            try {
                TimeUnit.MILLISECONDS.sleep(300);
            } catch (Exception ex) {
...
//        musicPlayer player = musicPlayer.getInstance();
        ...
        filepath = Connector.find_DB_SongPath(selectedSongName);
    }// GEN-LAST:event_jList1MouseClicked

    void loadDatabaseImage(String selectedSongName) {
        Connector con = new Connector();
        imagepath = Connector.find_DB_ImagePath(selectedSongName);
    }// GEN-LAST:event_jList1MouseClicked

    void loadDatabaseScale(String selectedSongName) {
//        musicPlayer player = musicPlayer.getInstance();
        Connector con = new Connector();
        scale = Connector.find_DB_Scale(selectedSongName);
    }
